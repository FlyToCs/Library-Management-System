...
//             WriteRowWrapped(new[] { header }, new[] { maxLen }, headerClr);
//             WriteLine(divider, headerClr);
//             foreach (var item in itemList)
//             {
//                 WriteRowWrapped(new[] { item?.ToString() ?? "" }, new[] { maxLen }, rowClr);
//                 WriteLine(divider, headerClr);
//             }
//             return;
//         }
...
//                         return "";
//
//                     // اگر IEnumerable باشد (آرایه، لیست و ...)
...
//
//         // محاسبه عرض هر ستون با در نظر گرفتن سقف
...
//         WriteRowWrapped(headers, maxWidths, headerClr);
//         WriteLine(tableDivider, headerClr);
//
//         // Rows
//         foreach (var row in rows)
//         {
//             WriteRowWrapped(row, maxWidths, rowClr);
//             WriteLine(tableDivider, headerClr);
//         }
//
//         // --- Local Functions ---
//         static void WriteRowWrapped(IEnumerable<string> cols, int[] widths, ConsoleColor? fg)
//         {
//             var colList = cols.ToList();
//             var wrappedCols = new List<List<string>>(colList.Count);
//
//             for (int i = 0; i < colList.Count; i++)
//                 wrappedCols.Add(WrapText(colList[i] ?? "", widths[i]));
//
